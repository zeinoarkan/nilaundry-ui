...
<div class="space-y-12 md:space-y-20 my-6 md:my-10">
        ...
        <div class="lg:col-span-7 relative overflow-hidden rounded-[2.5rem] bg-brand-600 shadow-glow group min-h-[350px] md:min-h-[400px] flex items-center">
            ...
            <div class="relative z-10 p-8 md:p-12 w-full">
                ...
                <div class="flex flex-wrap gap-4">
                    @auth
                        <a href="/layanan1" class="relative px-8 py-4 rounded-2xl bg-white text-brand-700 font-bold shadow-[0_10px_30px_rgba(255,255,255,0.3)] hover:shadow-[0_10px_40px_rgba(255,255,255,0.5)] hover:scale-102 transition-all flex items-center gap-3 group/btn overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="w-full h-6 bg-slate-200/50 rounded-full overflow-hidden border border-slate-100 shadow-inner p-1">
                        ...
                        <div x-data="{ width: 0 }"
                             ...
                             class="h-full rounded-full transition-all duration-[2000ms] cubic-bezier(0.34, 1.56, 0.64, 1) shadow-[0_0_15px_rgba(59,130,246,0.6)] relative"
                             :style="`width: ${width}%`">
    ...
    <div>
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
            <a href="/layanan1" class="group flex items-center gap-2 text-slate-500 hover:text-brand-600 font-bold transition-colors">
    ...
    <div class="rounded-[3rem] bg-slate-900 overflow-hidden relative p-12 md:p-20 text-center group shadow-2xl">
        ...
        <div class="relative z-10 max-w-3xl mx-auto">
            ...
            <a href="/layanan1" class="inline-flex px-10 py-5 rounded-2xl bg-white text-slate-900 font-bold text-lg hover:scale-105 hover:shadow-glow transition-all group/cta">
